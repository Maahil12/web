  ...
  return (
    <div style={{ height: "100%" }}>
      ...
      <Dialog open={showMobileDialog}>
        ...
        <DialogContent>
          Metx is not currently not supported on mobile devices. Please use a
      ...
      <div className="App App-header">
        <div style={{ width: "100%", backgroundColor: "#2F3136" }}>
          ...
          <div className="m-5">
            ...
            <Button
              ...
              onClick={() => {
                window.open(
                  "https://youtu.be/U-l4ya3ejko?si=2BmEysG7xMa3bG5e&t=75"
                );
              }}
            >
              <b>Find out more</b>
        ...
        >
          ...
          >
            ...
            <Card.Body>
              <Card.Text style={{ fontSize: "1.1rem" }}>
                As free as it gets. No ads, no subscriptions, and no fees. All
                of our features are free to use, forever.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card
          ...
          >
            <Card.Header>
              <IoInfiniteSharp style={{ marginBottom: "0.4rem" }} /> Unlimited
            </Card.Header>
            <Card.Body>
              <Card.Text style={{ fontSize: "1.1rem" }}>
                No limits. Upload as many files as you want with no storage
                limit. Movies, music, images, backups, everything.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card
          ...
          >
            <Card.Header>
              <BiLogIn style={{ marginRight: "0.4rem" }} />
              Simple
            </Card.Header>
            <Card.Body>
              <Card.Text style={{ fontSize: "1.1rem" }}>
                Just a discord account required. No email, no registration, no
                passwords, everything is tied to your Discord account. Just a
